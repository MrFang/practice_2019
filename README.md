...
![Рисунок 1](https://i.ibb.co/Z2FgL0F/Screenshot-from-2019-06-14-20-39-29.png)
...
* name -- varchar. Название типа документа. Максимальная длина: 50 знаков
* description -- text. Описание типа документа, может быть NULL (отсутствовать)
* ifActive -- bit. Флаг активности данного типа документа, принимает значения 1 или 0. Значение по-умолчанию 1
...
Форма под таблицей изменится на форму редактирования, которая будет предзаполненна текущими значениями изменяемой записи. После нажатия на кнопку "Edit" данные в таблице обновятся.
